...
<main class="col-lg-10 p-4">
    ...
    <form method="post" action="/admin/index.php?page=notices&action=<?= $isEdit ? 'update&id=' . (int) $notice['id'] : 'create'; ?>">
        <div class="row g-3">
        ...
        <div class="mt-3"><button type="submit" class="btn btn-success">Save</button><a href="/admin/index.php?page=notices" class="btn btn-secondary">Back</a></div>
    </form>
</main>
